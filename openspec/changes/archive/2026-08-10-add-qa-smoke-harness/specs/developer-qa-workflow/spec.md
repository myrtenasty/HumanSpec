...
Each automated QA scenario SHALL execute in an isolated temporary workspace and user environment. Host global configuration and previously installed tool artifacts SHALL not affect scenario outcomes.
